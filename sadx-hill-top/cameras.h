...
enum class CameraModesIDs : Uint16 {
	...
	// External-operated cameras
	Editor,
	GuriGuri,
	PathCam
};

enum class CameraAdjustsIDs : Uint8 {
	None,
	Normal,
	Normal_S,
	Slow,
...
enum class CameraDirectIDs : Uint8 {
	Sonic,
	Unknown,
	Target
};
...
FunctionPointer(void, ForceCameraMode, (CameraModesIDs type, CameraAdjustsIDs adjust), 0x437BF0);
